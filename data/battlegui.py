...
class InfoBox(object):
    ...
    def show_gold(self):
        '''
        Show much gold the player earned.
        '''
        return 'You found {} gold.'.format(self.gold_earned)

    def level_up(self):
        '''
        Return message indicating a level up for the player.
        '''
...
class SelectArrow(object):
    ...
    def __init__(self, enemy_pos_list, info_box):
        ...
        self.index = 0
        self.rect.topleft = self.post_list[self.index]
        self.allow_input = False
        self.enemy_pos_list = enemy_post_list
    ...
    def select_action(self, keys):
        ...
        '''
        self.pos_list = self.make_select_pos_list()
        if self.index > (len(self.pos_list) - 1):
            print self.post_list, self.index
    ...
    def make_select_magic_post_list(self):
        '''
